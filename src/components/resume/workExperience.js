			    ...
			    <div className='pure-menu pure-menu-horizontal'>
				    <ul className='pure-menu-list'>
						<li className='pure-menu-item'>
							<a href='#' className='pure-menu-item'>Informetric Systems - Software Application Engineer</a>
						</li>
						<li className='pure-menu-item'>
							<a href='#' className='pure-menu-item'>Campus Evolution - Analyst Intern</a>
						</li>
						<li className='pure-menu-item'>
							<a href='#' className='pure-menu-item'>La Buena Onda - Intern</a>
						</li>
				    </ul>
				</div>
...
/*
				    ...
				    <ul className="pure-menu-list">
				        ...
				        <li className="pure-menu-item pure-menu-has-children">
				            ...
				            <ul className="pure-menu-children">
				                <li className="pure-menu-item"><a href="#" className="pure-menu-link pure-menu-has-children">Email</a></li>
			    ...
			    <ul>
			      	<li>
			        	<h3>Informetric Systems - Software Application Engineer</h3>
		        	</li>
					<ul className='pure-menu-list'>
						<li className='pure-menu-item pure-menu-selected'>Technical Experience</li>
						<ul>
				...
				<li><h3>Campus Evolution - Analyst Intern</h3></li>
				<ul>
				...
				<li><h3>La Buena Onda - Intern</h3></li>
				<ul>
